...
$mail->Host = 'smtp.mail.ru';  						// настрой свою почту																	// Specify main and backup SMTP servers
...
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br>Почта этого пользователя: ' .$email. '<br>Поступивший вопрос от пользователя: ' .$question. '<br>Приложенный файл: ' .$file.;
$mail->AltBody = '';
